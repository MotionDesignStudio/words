...
$returnmylist='';//This stores the words from the selected list
//while(!feof($myfile)) {
	//Place each word in the array
	//$returnmylist=trim(fgets($myfile));
...
if ($myfile){
	while (($line= fgets($myfile)) !== false){
		$returnmylist=$returnmylist.$line. ', ';
	}
}
